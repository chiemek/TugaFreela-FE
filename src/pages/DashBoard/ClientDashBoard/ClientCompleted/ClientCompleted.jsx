    ...
    <>
      ...
      <main>
        <section>
          ...
          <aside>
            <div className="btn">
              <Button bgColor="yellow" textColor="black">
                Ativo
              </Button>
              <div style={{ display: "flex", gap: "1rem", marginTop: "1rem" }}>
                <Button>Concluir Rodada</Button>
                <Button>Iniciar Disputa</Button>
              </div>
            </div>
        ...
        <section>
          ...
          {proposal.map((prop, index) => (
            <div className="propose" key={`proposal-${index}`}>
              ...
              {<Button bgColor="#1ABF00">Iniciar Disputa</Button>}
              <img
                src={ThreeDot}
                alt="three dots"
                className="three-dot"
